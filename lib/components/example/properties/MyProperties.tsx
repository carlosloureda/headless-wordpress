...
import { GET_MY_PROPERTIES, UPDATE_PROPERTY } from '../../../../lib/queries/properties'
...
const MyProperties = ({ userId }: { userId: number }): JSX.Element => {
  const { data } = useQuery(GET_MY_PROPERTIES, {
